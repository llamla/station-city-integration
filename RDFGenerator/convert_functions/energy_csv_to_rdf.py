...
def create_owl_from_csv(input_file,output_file):
    ...
    with open(input_file, "r", encoding="GBK") as file:
        ...
        for entry in reader:
            ...
            if entry['observes']=="PipeTemperature":
                alarm_uri=EX["AbnormalEnergyConsumption"]
                g.add((alarm_uri, RDF.type, MR.Alarm))
                g.add((alarm_uri, RDF.type, MR.EnergyConsumptionWarning))
                g.add((alarm_uri, RDF.type, MR.AbnormalEnergyConsumption))
                g.add((alarm_uri, MR.id,
                       Literal("AbnormalEnergyConsumption", datatype="http://www.w3.org/2001/XMLSchema#string")))
            ...
            g.add((observed_property_uri, RDF.type, MR.EnergyConsumptionAttribute))
            ...
            g.add((sensor_uri, RDF.type, MR.EnergyConsumptionSensors))
            ...
            g.add((feature_of_interest_uri, RDF.type, MR.EnergyConsumption))
            ...
            g.add((observation_uri, RDF.type, MR.EnergyConsumptionObservation))
